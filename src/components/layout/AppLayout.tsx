...
export function AppLayout({ children }: AppLayoutProps) {
  ...
  return (
    <>
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:z-50 focus:top-4 focus:left-4 focus:bg-blue-600 focus:text-white focus:px-4 focus:py-2 focus:rounded focus:outline-none focus:ring-2 focus:ring-blue-400"
      >
        ...
        >
          ...
          <div className="fixed inset-0 flex">
            ...
            >
              ...
              <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-2 dark:bg-gray-900 dark:ring dark:ring-white/10">
